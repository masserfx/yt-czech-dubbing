...
import { handleRealtimeClientSecret } from './handlers/realtime-client-secret.js';
...
const ROUTES = [
  ...
  { method: 'POST', pattern: /^\/v1\/realtime\/client-secret$/, handler: handleRealtimeClientSecret, auth: true },
